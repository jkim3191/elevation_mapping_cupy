#!/bin/bash
IMAGE_NAME="bipedal_navigation"
HOST_HOME_DIR=$HOME
HOST_HOME_DIR=/home/jkim3191 # Change this to your home directory
catkin_ws="$HOST_HOME_DIR/GTLIDAR/ros2_BegForked_ws" # Change this to your catkin workspace directory
