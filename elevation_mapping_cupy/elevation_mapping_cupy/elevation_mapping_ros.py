...
class ElevationMappingNode(Node):
    ...
    def set_param_values_from_ros(self):
        ...
        try: 
            # The YAML has 'drift_compensation_variance_inlier', but our param is 'drift_compensation_variance_inlier'
